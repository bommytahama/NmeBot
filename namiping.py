...
id_list = [jah_id, knuc_id, terry_id]
sda_channel = 815405711726084156
...
async def nami_timer():
    ...
    if t.tm_wday <= send_day and not(t.tm_min > send_min and t.tm_hour == send_time and t.tm_wday == send_day):
        print('4-n-1')
